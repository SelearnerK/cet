        ...
        <el-tabs tab-position="left" style="height: 600px">
          <el-tab-pane label="局部预测环境浓度PEClocal">
            ...
            <el-form-item label="STP(PECstp)" prop="pecstp" v-if="true">
              <el-input v-model="result_PECstp"  auto-complete="off"></el-input>
            </el-form-item>
              </el-col>
              <el-col :span="12">
            <el-form-item label="STP风险商" prop="pecstp" v-if="true">
            ...
            <el-form-item label="地表水(PEClocal.water)" prop="peclocalWater" v-if="true" >
              <el-input v-model="result_PEClocal_water" auto-complete="off"></el-input>
            </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="地表水风险商" prop="peclocalWater" v-if="true" >
             ...
             <el-row>
               <el-col :span="12">
                 <el-form-item label="沉积物(PEClocal.sed)" prop="peclocalSed" v-if="true">
                   <el-input v-model="result_PEClocal_sed" auto-complete="off"></el-input>
                 </el-form-item>
               </el-col>
               <el-col :span="12">
                 <el-form-item label="沉积物风险商" prop="peclocalSed" v-if="true">
            ...
            <el-form-item label="土壤(PEClocal.soil,30)" prop="peclocalSoil30" v-if="true">
              <el-input v-model="result_PEClocalsoil_30" auto-complete="off"></el-input>
            </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="土壤风险商" prop="peclocalSoil30" v-if="true">
            ...
            <el-row>
              ...
              <el-form-item label="地下水(PEClocal.grw)" prop="peclocalGrw" v-if="true">
                <el-input v-model="result_compute_PEClocalgrw" auto-complete="off"></el-input>
              </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="地下水风险商" prop="peclocalGrw" v-if="true">
            ...
            <el-form-item label="水生捕食动物(PECaqu,predator)" prop="pecaquPredator" v-if="true">
                <el-input v-model="result_PECaqu_predator" auto-complete="off"></el-input>
              </el-form-item>
                </el-col>
                <el-col :span="12">
                  <el-form-item label="水生捕食动物风险商" prop="pecaquPredator" v-if="true">
            ...
            <el-row>
              ...
              <el-input v-model="result_compute_PECterPredator" auto-complete="off"></el-input>
            </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="陆生捕食动物风险商" prop="pecterPredator" v-if="true">
